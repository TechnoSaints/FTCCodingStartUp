...
@Config
@Autonomous(name = "AutoTemplateCenterstage", group = "Autonomous")
public class AutoTemplateCenterstage extends LinearOpMode {
    public class Lift {
    ...
    public void runOpMode() {
        AutoDrivetrain3Wheel drive = new AutoDrivetrain3Wheel(hardwareMap, new Pose2d(11.8, 61.7, Math.toRadians(90)));
