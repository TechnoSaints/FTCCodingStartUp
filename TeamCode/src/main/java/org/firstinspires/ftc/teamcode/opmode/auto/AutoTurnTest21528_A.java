...
@Config
@Autonomous(name = "AutoTurnTest21528_A", group = "Auto")

public class AutoTurnTest21528_A extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive() && !isStopRequested()) {
            ...
            telemetry.update();
            sleep(1000);
            botCoord.moveToPose(new Pose2D(DistanceUnit.INCH,0,0, AngleUnit.DEGREES,135));
            telemetry.addLine("Second move complete...");
            telemetry.update();
            sleep(1000);
            botCoord.moveToPose(new Pose2D(DistanceUnit.INCH, 0, 0, AngleUnit.DEGREES, 180));
