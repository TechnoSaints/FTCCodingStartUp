...
@Config
@Autonomous(name = "AutoComplexMoveTest21528_A", group = "Auto")

public class AutoComplexMoveTest21528_A extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive() && !isStopRequested()) {
            ...
            telemetry.update();
            botCoord.moveToPose(new Pose2D(DistanceUnit.INCH,24,24, AngleUnit.DEGREES,90));
            telemetry.addLine("First move complete...");
            telemetry.update();
            sleep(1000);
            botCoord.moveToPose(new Pose2D(DistanceUnit.INCH,-6,-12, AngleUnit.DEGREES,-90));
            telemetry.addLine("Second move complete...");
            telemetry.update();
            sleep(1000);
            botCoord.moveToPose(new Pose2D(DistanceUnit.INCH, 0, 24, AngleUnit.DEGREES, -135));
